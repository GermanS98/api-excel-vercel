...
const ResultSummary = ({ result }: { result: SimpleResult }) => {
        const summaryData = [
                ...
                { label: 'Intereses Corridos', value: result.intereses_corridos !== undefined ? formatNumberAR(result.intereses_corridos, 4, true) : undefined },
                { label: 'Precio Dirty', value: result.precio_dirty !== undefined ? formatNumberAR(result.precio_dirty, 4, true) : undefined },
